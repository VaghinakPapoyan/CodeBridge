          ...
          <div className="container grid gap-6 md:grid-cols-2 md:gap-12 items-center container mx-auto px-4">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground md:text-xl">
                CodeBridge-ը առաջարկում է ծրագրավորման որակյալ դասընթացներ
                Արմավիր քաղաքում
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Մենք ծրագրավորման կենտրոն ենք Արմավիրում, որի նպատակն է
                տրամադրել որակյալ կրթություն: Օգտագործելով դասավանդման
                ամենաժամանակակից մեթոդները` վստահ ենք, որ մեր տված գիտելիքները
                պետք կգան բոլորին
              </p>
